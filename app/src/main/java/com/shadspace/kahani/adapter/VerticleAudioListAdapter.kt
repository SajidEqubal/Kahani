...
class VerticleAudioListAdapter(private val audioIdList: List<String>) :
    RecyclerView.Adapter<VerticleAudioListAdapter.MyViewHolder>() {

    class MyViewHolder(private val binding: AudioListItemRecyclerRowBinding) :
...
//                        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = AudioListItemRecyclerRowBinding.inflate(
